...
{
    /// <inheritdoc />
    public partial class UpdateUserTableAndIdentityEntities : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ResetPasswordLinkSent = table.Column<bool>(type: "bit", nullable: false),
                    ResetPasswordLinkSentRecord = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Black man cyberpunk", "1.png", null },
                    { 2, "White woman cyberpunk", "2.png", null },
                    { 3, "White man spy", "3.png", null },
                    { 4, "White woman spy", "4.png", null },
                    { 5, "White man cyber warrior", "5.png", null }
                });
