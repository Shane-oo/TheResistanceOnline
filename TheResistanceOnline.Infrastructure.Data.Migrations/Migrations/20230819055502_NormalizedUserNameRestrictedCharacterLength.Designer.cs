...
namespace TheResistanceOnline.Infrastructure.Data.Migrations.Migrations
{
    ...
    [Migration("20230819055502_NormalizedUserNameRestrictedCharacterLength")]
    partial class NormalizedUserNameRestrictedCharacterLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TheResistanceOnline.Data.PlayerStatistics.PlayerStatistic", b =>
                {
                    ...
                    b.HasOne("TheResistanceOnline.Data.Entities.UserEntities.User", null)
                        .WithMany("PlayerStatistics")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
